...
const gifts: Gift[] = [
  ...
  { id: 9, name: 'Jogo de Cama', image: '/img/JOGO_DE_CAMA.webp' },
  { id: 10, name: 'Jogo de Copos', image: '/img/JOGO_DE_COPOS.webp' },
  { id: 11, name: 'Jogo de Taças', image: '/img/JOGO_DE_TACAS.jpg' },
  { id: 12, name: 'Jogo de Xícaras', image: '/img/JOGO_DE_XICARAS.webp' },
  { id: 13, name: 'Kit de Sobremesa', image: '/img/JOGO_DE_SOBREMESA.jpg' },
  { id: 14, name: 'Jogo de Pano de Prato', image: '/img/JOGO_DE_PANO_DE_PRATO.webp' },
  { id: 15, name: 'Potes Herméticos', image: '/img/POTES_HERMETICOS.webp' },
  { id: 16, name: 'Filtro', image: '/img/FILTRO.webp' },
  { id: 17, name: 'Forno Elétrico', image: '/img/FORNO_ELETRICO.webp' },
  { id: 18, name: 'Kit Faqueiro', image: '/img/KIT_FAQUEIRO.webp' },
  { id: 19, name: 'Jarra de Vidro', image: '/img/JARRA_DE_VIDRO.webp' },
  { id: 20, name: 'Panela de Pressão', image: '/img/PANELA_DE_PRESSAO.webp' },
  { id: 21, name: 'Batedeira', image: '/img/BATEDEIRA.webp' },
  { id: 22, name: 'Garrafa de café', image: '/img/GARRAFA_DE_CAFE.webp' },
  { id: 23, name: 'Cortinas', image: '/img/CORTINAS.jpg' },
  { id: 24, name: 'Televisão', image: '/img/TELEVISAO.jpg' },
  ...
  { id: 28, name: 'Jogo de Talheres', image: '/img/JOGO_TALHERES2.webp' },
  ...
  { id: 36, name: 'Travesseiros', image: '/img/TRAVESSEIROS.jpg' },
];
