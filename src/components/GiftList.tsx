...
const gifts: Gift[] = [
  ...
  { id: 7, name: 'Jogo de Talheres Inox', image: '/img/COLHER.jpg' },
  { id: 8, name: 'Ferro de Passar', image: '/img/FERRO_DE_PASSAR.webp' },
  { id: 9, name: 'Pix', image: '/img/pix.jpg' },
  ...
  { id: 22, name: 'Pix', image: '/img/pix2.jpg' },
  ...
  { id: 28, name: 'Pix', image: '/img/pix2.jpg' },
  ...
  { id: 33, name: 'Pix', image: '/img/pix3.jpg' },
  ...
  { id: 42, name: 'Cama de Casal', image: '/img/CAMA.jpg' },
