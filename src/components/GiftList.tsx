...
const gifts: Gift[] = [
  { id: 1, name: 'Jogo de Panelas', image: 'public/img/JOGO DE PANELA.jpg' },
  { id: 2, name: 'Edredom Casal', image: 'public/img/EDREDOM CASAL.jpg' },
  { id: 3, name: 'Liquidificador', image: 'public/img/LIQUIDIFICADOR.webp' },
  { id: 4, name: 'Jogo de Toalhas', image: 'public/img/JOGO DE TOALHA.jpg' },
  { id: 5, name: 'Sanduicheira', image: 'public/img/SANDUICHEIRA.webp' },
  { id: 6, name: 'Jogo de Prato', image: 'public/img/JOGO DE PRATOS.jpg' },
  { id: 7, name: 'Jogo de Talheres', image: 'public/img/JOGO DE TALHERES.webp' },
  { id: 8, name: 'Ferro de Passar', image: 'public/img/FERRO DE PASSAR.webp' },
  { id: 9, name: 'Jogo de Cama', image: 'public/img/JOGO DE CAMA.webp' },
  { id: 10, name: 'Jogo de Copos', image: 'public/img/JOGO DE COPOS.webp' },
  { id: 11, name: 'Jogo de Taças', image: 'public/img/JOGO DE TAÇAS.jpg' },
  { id: 12, name: 'Jogo de Xícaras', image: 'public/img/JOGO DE XÍCARAS.webp' },
  { id: 13, name: 'Kit de Sobremesa', image: 'public/img/JOGO DE SOBREMESA.jpg' },
  { id: 14, name: 'Jogo de Pano de Prato', image: 'public/img/JOGO DE PANO DE PRATO.webp' },
  { id: 15, name: 'Potes Herméticos', image: 'public/img/POTES  HERMÉTICOS.webp' },
  { id: 16, name: 'Filtro', image: 'public/img/FILTRO.webp' },
  { id: 17, name: 'Forno Elétrico', image: 'public/img/FORNO ELÉTRICO.webp' },
  { id: 18, name: 'Kit Faqueiro', image: 'public/img/KIT FAQUEIRO.webp' },
  { id: 19, name: 'Jarra de Vidro', image: 'public/img/JARRA DE VIDRO.webp' },
  { id: 20, name: 'Panela de Pressão', image: 'public/img/PANELA DE PRESSÃÕ.webp' },
  { id: 21, name: 'Batedeira', image: 'public/img/BATEDEIRA.webp' },
  { id: 22, name: 'Garrafa de café', image: 'public/img/GARRAFA DE CAFÉ.webp' },
  { id: 23, name: 'Cortinas', image: 'public/img/CORTINAS.jpg' },
  { id: 24, name: 'Televisão', image: 'public/img/TELEVISÃO.jpg' },
  { id: 25, name: 'Aspirador de Pó', image: 'public/img/ASPIRADOR DE PÓ.webp' },
  { id: 26, name: 'Fogão', image: 'public/img/FOGÃO.webp' },
  { id: 27, name: 'Máquina de Lavar Roupas', image: 'public/img/MÁQUINA DE LAVAR ROUPAS.jpg' },
  { id: 28, name: 'Panela de Pressão', image: 'public/img/PANELA DE PRESSÃÕ.webp' },
];
